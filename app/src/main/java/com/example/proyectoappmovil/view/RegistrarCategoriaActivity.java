...
public class RegistrarCategoriaActivity extends AppCompatActivity {
    ...
    public void registrarCategoria(){
        ...
        values.put(Utilidades.CAMPO_NOMBRE_CATEGORIA, nombreCategoria.getText().toString());
        Long idResultado=bd.insert(Utilidades.TABLA_CATEGORIA,Utilidades.CAMPO_ID_CATEGORIA, values);
    ...
    public void registrar(View view) {
        ...
        if(TextUtils.isEmpty(valor)){
            ...
            Toast.makeText(RegistrarCategoriaActivity.this,"Ingrese un nombre",Toast.LENGTH_SHORT).show();
            return;
